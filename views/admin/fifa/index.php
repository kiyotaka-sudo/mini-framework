...
<div class="admin-container">
    <div class="admin-header">
        <h1>Fifa Management</h1>
        <a href="/admin/fifa/create" class="btn btn-primary">+ New Fifa</a>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $item['id'] ?></td>
                    <td><?= htmlspecialchars($item['asis']) ?></td>
                <td>
                    <a href="/admin/fifa/<?= $item['id'] ?>/edit" class="btn btn-primary">Edit</a>
...
function deleteItem(id) {
    ...
    fetch(`/api/fifa/${id}`, { method: 'DELETE' })

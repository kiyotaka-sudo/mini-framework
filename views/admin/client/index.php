...
<div class="admin-container">
    <div class="admin-header">
        ...
        <a href="/admin/client/create" class="btn btn-primary">+ New Client</a>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $item['id'] ?></td>
                    <td><?= htmlspecialchars($item['nomp']) ?></td>
                    <td><?= htmlspecialchars($item['age p']) ?></td>
                <td>
                    <a href="/admin/client/<?= $item['id'] ?>/edit" class="btn btn-primary">Edit</a>

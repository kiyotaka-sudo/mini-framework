...
<div class="admin-container">
    <div class="admin-header">
        <h1>Produit Management</h1>
        <a href="/admin/produit/create" class="btn btn-primary">+ New Produit</a>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/admin/produit/<?= $item['id'] ?>/edit" class="btn btn-primary">Edit</a>
...
function deleteItem(id) {
    ...
    fetch(`/api/produit/${id}`, { method: 'DELETE' })
